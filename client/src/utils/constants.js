...
export const getIceServers = () => {
  ...
  // If TURN credentials are provided 
...
export const APP_CONFIG = {
  ...
  APP_DESCRIPTION: 'Connect, learn, and collaborate in real time with high-quality native WebRTC video conferencing, screen sharing, and interactive chat inspired by Google Meet.',
  ...
  FEATURES: [
    {
      ...
      description: 'Peer-to-peer crystal clear video and spatial audio powered by native WebRTC',
    ...
    },
    {
      ...
      description: 'Share your entire screen, application window, or browser tab with full audio',
    ...
    },
    {
      ...
      description: 'Instant meeting chat and participant interactions powered by Socket.IO',
    ...
    },
    {
      ...
      description: 'End-to-end media encryption, OTP email verification, and Google OAuth login',
  ...
  HOME_CONTENT: {
    HERO: {
      ...
      SUBHEADING: 'Host and join real-time interactive video classes with ultra-low latency WebRTC streaming, screen sharing, and Google Meet-style collaboration.',
    ...
    FEATURES: {
      ...
      DESCRIPTION: 'Engineered for smooth classes, lectures, and team collaboration with low latency',
    },
    BENEFITS: {
      HEADING: 'Why Choose {APP_NAME}?',
      DESCRIPTION: 'Experience lightning-fast video meetings with zero external video SDK locks.',
    },
    CTA: {
      HEADING: 'Ready to Host Your Next Live Session?',
      DESCRIPTION: 'Join instructors and students collaborating smoothly every day.',
  ...
  DASHBOARD_CONTENT: {
    ...
    ACTION_CARDS: {
      HOST: {
        TITLE: 'New Meeting',
        DESCRIPTION: 'Start an instant Google Meet-style video room and share the invite code',
        BUTTON: 'Start Meeting',
        BUTTON_LOADING: 'Creating Meeting...',
      },
      JOIN: {
        TITLE: 'Join Meeting',
        DESCRIPTION: 'Enter a meeting room code or link to join an existing session',
        BUTTON: 'Join Meeting',
      },
    },
    SESSIONS_LIST: {
  ...
  SESSION_CONTENT: {
    JOIN_FORM: {
      ...
      DESCRIPTION: 'Enter the meeting code (e.g., abc-defg-hij) to enter the lobby',
