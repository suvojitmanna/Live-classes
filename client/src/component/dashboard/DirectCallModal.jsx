...
import { FaPhoneAlt, FaVideo, FaEnvelope, FaSpinner, FaExclamationCircle } from "react-icons/fa";
import { useDirectCall } from "../../context/DirectCallContext";
import { useAuth } from "../../context/AuthContext";
import toast from "react-hot-toast";

const DirectCallModal = ({ isOpen, onClose }) => {
  const { user } = useAuth();
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleModalClose} title="Direct Call" maxWidth="max-w-md">
      <div className="space-y-5">
        <p className="text-xs text-gray-600 dark:text-gray-400">
          Enter the email address of any registered user to initiate a direct one-to-one video or voice call.
        </p>
